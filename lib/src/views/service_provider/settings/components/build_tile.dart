...
class BuildTile extends StatelessWidget {
  ...
  final Widget? routeOne;
  final Widget? routeTwo;
  const BuildTile({
    Key? key,
    this.leftIcon,
    this.textDesc,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => routeOne!));
              },
              child: Row(
            ...
            kTinyVerticalSpacing,
            InkWell(
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => routeTwo!)),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(
